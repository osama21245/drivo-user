...
class _AddNewAddressState extends State<AddNewAddress> {
  ...
  void initState() {
    ...
    if (widget.address != null) {
      Get.find<LocationController>().locationController.text =
    ...
    nameController.text =
        '${Get.find<ProfileController>().profileModel!.data!.firstName!} '
                ...
                child: Column(
                    ...
                    children: [
                                  ...
                                  onCameraIdle: () {
                                    if (_cameraPosition != null) {
                                      locationController.updatePosition(
                                          _cameraPosition?.target, false, null);
                                    }
                                  },
                        ...
                        Positioned(
                          ...
                          child: Align(
                            ...
                            child: SizedBox(
                                width: 50,
                                height: 50,
                                child: Image.asset(Images.pickLocation)),
                          ),
                        )),
                        Positioned(
                            child: Padding(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(children: [
                                    ...
                                    Text(addressController
                                        .addressTypeList[index].title.tr),
                                  ]),
                                ),
                              ),
                            )),
                      ...
                      CustomTextField(
                        ...
                        read: true,
                        controller:
                            Get.find<LocationController>().locationController,
                        inputAction: TextInputAction.next,
                        onTap: () {
                          Get.to(() => SearchAndPickLocationScreen(
