                    ...
                    child: Column(
                      ...
                      Text.rich(TextSpan(
                        ...
                        children: [
                          ...
                          TextSpan(
                            text: double.parse(
                                    tripDetails.driverAvgRating != null
                                        ? tripDetails.driverAvgRating.toString()
                                        : '0')
                                .toStringAsFixed(1),
                            style: textRegular.copyWith(
                                fontSize: Dimensions.fontSizeDefault),
          ...
          tripDetails.vehicle != null
              ? Flexible(
                  ...
                  child: Column(
                      ...
                      children: [
                        Text(
                          tripDetails.vehicle!.licencePlateNumber ?? '',
                          style: textMedium.copyWith(
                              fontSize: Dimensions.fontSizeDefault),
                          overflow: TextOverflow.ellipsis,
                        ),
                        Row(children: [
                          ...
                          Container(
                            ...
                            child:
                                Text(tripDetails.vehicleCategory?.name ?? ''),
                          )
                        ]),
                      ]))
              : const SizedBox(),
