          ...
          child: Column(
            children: [
              ParcelItemInfoWidget(
                  icon: Images.deliveryDetailsIcon,
              ...
              if (tripDetails.currentStatus == 'returning') ...[
                ParcelItemInfoWidget(
                    ...
                    title: 'paid'.tr,
                    amount: (tripDetails.paidFare ?? 0) -
                        (tripDetails.dueAmount ?? 0)),
                ParcelItemInfoWidget(
                    icon: Images.farePrice,
                    title: 'due'.tr,
                    amount: tripDetails.dueAmount ?? 0),
              ],
              const SizedBox(
...
class _ParcelTrackWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return tripDetails.type == 'parcel'
        ? Column(children: [
              ...
              child: Row(
                  ...
                  children: [
                      ...
                      InkWell(
                        onTap: () {
                          ...
                          Clipboard.setData(ClipboardData(
                              text: _getParcelTrackUrl(tripDetails.refId)));
                        },
                    ...
                    ButtonWidget(
                      ...
                      height: 32,
                      onPressed: () => launchUrl(
                          Uri.parse(_getParcelTrackUrl(tripDetails.refId))),
                    ),
                  ]),
            ),
          ])
