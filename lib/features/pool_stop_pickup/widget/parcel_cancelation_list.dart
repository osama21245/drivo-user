...
import 'parcel_custom_radio_button.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<TripController>(builder: (tripController) {
      return Column(children: [
        if ((widget.isOngoing
                ? tripController
                    .parcelCancellationReasonList!.data!.ongoingRide!.length
                : tripController
                    .parcelCancellationReasonList!.data!.acceptedRide!.length) >
            1)
          ListView.builder(
            shrinkWrap: true,
            ...
            itemBuilder: (context, index) {
              return ParcelCustomRadioButton(
                text: widget.isOngoing
                    ? tripController
                        .parcelCancellationReasonList!.data!.ongoingRide![index]
                    : tripController.parcelCancellationReasonList!.data!
                        .acceptedRide![index],
                isSelected:
                    tripController.parcelCancellationCauseCurrentIndex == index,
                onTap: () {
