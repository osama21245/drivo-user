...
class CarPollParcelOtpBottomSheetWidget extends StatefulWidget {
  final GlobalKey<ExpandableBottomSheetState> expandableKey;
  const CarPollParcelOtpBottomSheetWidget(
      {super.key, required this.expandableKey});

  @override
  State<CarPollParcelOtpBottomSheetWidget> createState() =>
      _CarPollParcelOtpBottomSheetWidgetState();
}

class _CarPollParcelOtpBottomSheetWidgetState
    extends State<CarPollParcelOtpBottomSheetWidget> {
  int currentState = 0;
