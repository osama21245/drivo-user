...
class CarPollParcelAcceptRiderWidget extends StatefulWidget {
  final GlobalKey<ExpandableBottomSheetState> expandableKey;
  const CarPollParcelAcceptRiderWidget(
      {super.key, required this.expandableKey});

  @override
  State<CarPollParcelAcceptRiderWidget> createState() =>
      _CarPollParcelAcceptRiderWidgetState();
}

class _CarPollParcelAcceptRiderWidgetState
    extends State<CarPollParcelAcceptRiderWidget> {
  int currentState = 0;
