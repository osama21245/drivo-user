...
class CarPollInitialWidget extends StatefulWidget {
  final GlobalKey<ExpandableBottomSheetState> expandableKey;
  const CarPollInitialWidget({super.key, required this.expandableKey});

  @override
  State<CarPollInitialWidget> createState() => _CarPollInitialWidgetState();
}

class _CarPollInitialWidgetState extends State<CarPollInitialWidget> {
  String? zoneExtraFareReason;
  @override
  void initState() {
    var rideController = Get.find<CarPollRideController>();
              ...
              : (Get.find<ConfigController>().config!.bidOnFare!)
                  ...
                  : ButtonWidget(
                      ...
                      onPressed: () {
                        rideController
                            .submitRideRequest(
                                rideController.noteController.text, false, null)
                            .then((value) {
