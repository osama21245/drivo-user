...
import 'package:ride_sharing_user_app/features/pool_stop_pickup/widget/parcel_cancelation_list.dart';
...
class CarPollParcelOngoingBottomSheetWidget extends StatefulWidget {
  final GlobalKey<ExpandableBottomSheetState> expandableKey;
  const CarPollParcelOngoingBottomSheetWidget(
      {super.key, required this.expandableKey});

  @override
  State<CarPollParcelOngoingBottomSheetWidget> createState() =>
      _CarPollParcelOngoingBottomSheetWidgetState();
}

class _CarPollParcelOngoingBottomSheetWidgetState
    extends State<CarPollParcelOngoingBottomSheetWidget> {
  int currentState = 0;
                ...
                : Column(
                    ...
                    children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(
                              horizontal: Dimensions.paddingSizeDefault),
                          child: Text('if_you_cancel_your_parcel_will_back'.tr,
                              style: textBold.copyWith(
                                  fontSize: Dimensions.fontSizeDefault)),
                        ),
                        const SizedBox(height: Dimensions.paddingSizeSmall),
                            ...
                            rideController
                                .tripStatusUpdate(
                                    ...
                                    (Get.find<TripController>()
                                                ...
                                                1) ==
                                            Get.find<TripController>()
                                                .parcelCancellationCauseCurrentIndex
                                        ? Get.find<TripController>()
                                ...
                                .then((value) {
                              if (rideController
                                      .tripDetails?.parcelInformation?.payer ==
                                  'receiver') {
