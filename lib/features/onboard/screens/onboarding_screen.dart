...
class _OnBoardingScreenState extends State<OnBoardingScreen>
  ...
  final List<Widget> pages = AppConstants.onBoardPagerData
  ...
  void dispose() {
    ...
    _pageController
        .dispose(); // Dispose PageController as well if not used elsewhere
    super.dispose();
  }
                      ...
                      children: [
                        ...
                        PageView(
                          ...
                          onPageChanged: (value) {
                            ...
                            _controller
                                .reset(); // Reset the animation to start over
        ...
        IconButton(
          onPressed: () {
            if (AppConstants.onBoardPagerData.length - 1 ==
                Get.find<OnBoardController>().pageIndex) {
              Get.find<ConfigController>().disableIntro();
              Get.offAll(() => const SignInScreen());
            } else {
