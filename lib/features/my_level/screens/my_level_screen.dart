...
class _MyLevelScreenState extends State<MyLevelScreen> {
              ...
              : Padding(
                  ...
                  child: Column(children: [
                    ...
                    Row(mainAxisSize: MainAxisSize.min, children: [
                      Text(
                        levelController.levelModel?.data?.currentLevel?.name ??
                            '',
                        style: textBold.copyWith(
                      ...
                      Row(children: [
                        Expanded(
                          ...
                          value: _calculateProgressValue(
                            ...
                            _calculateTotalTargetPoint(
                              levelController.levelModel?.data?.currentLevel
                                      ?.targetedRidePoint ??
                                  1,
                              levelController.levelModel?.data?.currentLevel
                                      ?.targetedAmountPoint ??
                    ...
                    !(((levelController.levelModel?.data?.currentLevel?.targetedRide ?? 0) <=
                                (levelController
                                        ...
                                        ?.rideComplete ??
                                    0)) &&
                            ((levelController.levelModel?.data?.currentLevel?.targetedAmount ??
                                    0) <=
                                (levelController
                                        .levelModel
                                        ?.data
                        ...
                        ? Expanded(
                            child: SingleChildScrollView(
                              child: Column(children: [
                                if ((levelController.levelModel?.data
                                            ?.currentLevel?.targetedRide
                                            ?.toInt() ??
                                        0) >
                                    0) ...[
                                  Container(
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          TargetNotificationTitle(
                                            completedValue: levelController
                                                    .levelModel
                                                    ?.data
                                                    ?.completedCurrentLevelTarget
                                                    ?.rideComplete ??
                                                0,
                                            targetValue: levelController
                                                    .levelModel
                                                    ?.data
                                                    ?.currentLevel
                                                    ?.targetedRide ??
                                          ...
                                          Row(children: [
                                            Expanded(
                                              child: Text(
                                                '${levelController.levelModel?.data?.completedCurrentLevelTarget?.rideCompletePoint?.toInt()} ${'points'.tr}',
                                                style: textBold.copyWith(
                                                  color: Theme.of(context)
                                                      .primaryColor,
                                                  fontSize:
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          ...
                                          Row(children: [
                                            Expanded(
                                              child: Text(
                                                '${levelController.levelModel?.data?.completedCurrentLevelTarget?.reviewGivenPoint?.toInt()} ${'points'.tr}',
                                                style: textBold.copyWith(
                                                  color: Theme.of(context)
                                                      .primaryColor,
                                                  fontSize:
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          ...
                                          Row(children: [
                                            Expanded(
                                              child: Text(
                                                '${levelController.levelModel?.data?.completedCurrentLevelTarget?.spendAmountPoint?.toInt()} ${'points'.tr}',
                                                style: textBold.copyWith(
                                                  color: Theme.of(context)
                                                      .primaryColor,
                                                  fontSize:
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          ...
                                          Row(children: [
                                            Expanded(
                                              child: Text(
                                                '${levelController.levelModel?.data?.completedCurrentLevelTarget?.cancellationRatePoint?.toInt()} ${'points'.tr}',
                                                style: textBold.copyWith(
                                                  color: Theme.of(context)
                                                      .primaryColor,
                                                  fontSize:
  ...
  String _targetNotificationSubTitle(
      double completedValue, double targetValue) {
    if (completedValue == 0) {
